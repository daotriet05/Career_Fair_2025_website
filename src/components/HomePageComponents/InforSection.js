  ...
  return (
    <>
      <div className='home-page-section' style={{ backgroundColor: 'white', height: '100vh'}}>
        <section className="pt-10 py-8 lg:px-20 flex items-center justify-center max-h-screen">
          <div className="main-sm:max-w-xs md:max-w-lg lg:max-w-7xl mx-auto flex flex-col md:flex-col lg:flex-row gap-8;">
            ...
            <div className="lg:w-1/2" style={{fontFamily:"Montserrat"}}> {/* Left Section Container */}
              ...
              <ul className="px-14 lg:text-xl text-left mt-4 list-disc list-outside space-y-2 text-gray-700 tracking-normal italic">
            ...
            <div className="lg:w-1/2 text-right">
              <h2 className="text-yellow-500 text-5xl lg:text-7xl mt-5 font-bold leading-tight px-5" style={{fontFamily:"IntroRust"}}> {/* Text with gradient and Intro Rust font */}
        ...
        <div className="lg:pl-36 float-left text-left pl-16 mt-5 lg:mt-10">
          <strong className="text-3xl">Contact Information</strong>
          <p className="text-lg">Mrs. Vo Phan Hoang Trang - Tel. - Email:</p>
        </div>
        <div>
        <div className="w-11/12 lg:w-8/12 h-2 lg:h-4 lg:mt-4 lg:mb-8 lg:mb-5 mx-auto lg:float-right" style={{backgroundColor:"#145f48"}}></div> {/* Teal footer */}
          <div className="float-right flex gap-6 mr-20 lg:mr-12 h-12 mt-6 lg:mt-0">
            <div className="icon">
              <img src={www} className="icon-img"></img>
            </div>
            <div className="icon">
              <img src={facebook} className="icon-img"></img>
            </div>
            <div className="icon">
              <img src={email} className="icon-img"></img>
            </div>
            <div className="icon">
              <img src={location} className="icon-img"></img>
            </div>
          </div>
        </div>
      </div>
