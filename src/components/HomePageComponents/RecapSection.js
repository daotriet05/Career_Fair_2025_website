...
function RecapSection() {
  return (
    <div
      className="home-page-section overflow-x-hidden min-h-screen"
      style={{
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto text-center flex-1 flex flex-col px-4 sm:px-8 py-1 sm:pt-28 sm:pb-4 sm:py-0 box-border">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-8 mb-10">
          <div>
            <h3 className="text-2xl font-bold text-[#e5ea98] mb-2">
